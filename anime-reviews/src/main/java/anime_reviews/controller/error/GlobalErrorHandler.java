package anime_reviews.controller.error;
...
public class GlobalErrorHandler {
    ...
    private ExceptionMessage buildExceptionMessage(Exception ex, HttpStatus status,
        ...
        ExceptionMessage excMessage = new ExceptionMessage();

        excMessage.setMessage(message);
        excMessage.setStatusReason(statusReason);
        excMessage.setStatusCode(statusCode);
        excMessage.setTimestamp(timestamp);
        excMessage.setUri(uri);
